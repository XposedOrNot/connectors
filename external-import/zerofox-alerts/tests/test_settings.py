...
class TestValidSettings:
    ...
    def test_defaults_applied_correctly(self):
        ...
        assert settings.zerofox_alerts.api_base_url == "https://api.zerofox.com"
        assert settings.zerofox_alerts.marking == "TLP:AMBER"
    ...
    def test_full_settings_override_defaults(self):
        ...
        assert settings.zerofox_alerts.marking == "TLP:GREEN"
